...
def build_combined_categorical(FLAGS, NUM_FILTERS, FILTER_LENGTH1, FILTER_LENGTH2):
    ...
    encode_smiles = LSTM(units=64, dropout=0.1, recurrent_dropout=0.1, return_sequences=True)(encode_smiles)
    ...
    encode_protein = LSTM(units=64, dropout=0.1, recurrent_dropout=0.1, return_sequences=True)(encode_protein)
